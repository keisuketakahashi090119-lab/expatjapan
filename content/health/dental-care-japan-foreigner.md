...
1. **Register at a local clinic early** — before you have a problem, not during one
2. **Bring your insurance card (保険証)** to every visit
3. **Monthly installments** are often available for large treatments like implants
4. **University dental hospitals** offer lower prices but longer wait times (taught by supervised students)
