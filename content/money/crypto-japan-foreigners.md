---
title: "Cryptocurrency in Japan for Foreigners: Exchanges, Taxes, and Rules (2026)"
date: 2026-05-25
...
1. **Keep records from day one** — every transaction, even small ones
2. **Use Cryptact or Gtax** — do not try to calculate manually
3. **Consider NISA for stock investing instead** — more favorable tax treatment (0% within NISA limits)
4. **If gains are large, consult a tax accountant (税理士)** who handles crypto
5. **Don't assume your home country's rules apply** — they don't while you're resident in Japan
