...
**Fee:** 0.09372% annually
**Why choose this over All-Country:** If you believe US markets will continue outperforming. More concentrated risk, historically higher returns.
...
See our [best savings account guide](/money/best-savings-account-japan-foreigners/) for the full comparison.
...
| Interface | Japanese | Japanese |
| Linked savings | SBI Sumishin (1.0%) | Rakuten Bank (0.2% base) |
| Points program | T-Point, Pontaポイント | Rakuten Points |
| Best for | SBI banking users | Rakuten ecosystem users |
| Foreign-friendliness | Similar | Similar |
...
**Can foreigners open a NISA account at SBI Securities?**
Yes — foreigners with a valid residence card and My Number card can open a NISA account at SBI Securities. US citizens may face additional hurdles due to FATCA requirements.

**What is the best fund for NISA in Japan?**
eMAXIS Slim 全世界株式 (オール・カントリー) is the most recommended fund for most investors — ultra-low 0.05774% annual fee, global diversification, and available at SBI and Rakuten Securities. eMAXIS Slim S&P500 is the alternative for those who want US-only exposure.

**How much can I invest in NISA each year?**
The new NISA (Shin NISA) from 2024 allows up to ¥3,600,000 per year — ¥1,200,000 in the Tsumitate account and ¥2,400,000 in the Growth account. Lifetime limit: ¥18,000,000.
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Can foreigners open a NISA account at SBI Securities?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes — foreigners with a valid residence card and My Number card can open a NISA account at SBI Securities. US citizens may face additional FATCA-related requirements."
      }
    },
    {
      "@type": "Question",
      "name": "What is the best fund for NISA in Japan?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "eMAXIS Slim 全世界株式 (オール・カントリー) is the most recommended — 0.05774% annual fee, global diversification. eMAXIS Slim S&P500 is the alternative for US-focused investors."
      }
    }
  ]
}
