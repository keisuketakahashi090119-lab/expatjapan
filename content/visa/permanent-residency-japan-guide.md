...
1. **Tax arrears** — unpaid or late-paid taxes
2. **Pension gaps** — missed payments without exemption record
3. **Insufficient residence period** — not meeting the time requirement
4. **Income too low** — suggests inability to self-support
5. **Past visa violations** — overstays, working outside permitted status
