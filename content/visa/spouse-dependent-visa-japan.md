...
| Document | Notes |
|---|---|
| Application form | Download from Immigration Services Agency |
| Passport (dependent's) | |
| Photograph (4cm × 3cm) | |
| Residence card copy (sponsor's) | |
| Marriage certificate | Authenticated + translated into Japanese |
| Birth certificate (for children) | Authenticated + translated |
| Sponsor's Certificate of Employment | 在職証明書 — from employer |
| Sponsor's tax/income proof | 源泉徴収票 or 課税証明書 |
...
### Applying from Outside Japan (Recommended)
...
- [Children's Healthcare in Japan for Foreign Parents](/daily-life/children-healthcare-japan/)
