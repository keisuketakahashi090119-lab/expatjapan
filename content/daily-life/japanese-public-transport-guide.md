---
title: "Japan Public Transport Guide for Foreigners: Trains, Buses, and IC Cards (2026)"
date: 2026-05-25
...
| Subway (地下鉄) | Metro / Municipal | Urban underground networks |
| Private railway (私鉄) | Tokyu, Keio, Hankyu, etc. | Many urban and suburban lines |
| Bus (バス) | Various | Less punctual; useful for areas without trains |
| Shinkansen (新幹線) | JR | High-speed rail between cities |
| Taxi / ride-share | Various | Expensive; useful for late night |
...
| Card | Region | Notes |
|---|---|---|
| **Suica (スイカ)** | Tokyo/JR East | Most widely accepted |
| **PASMO (パスモ)** | Tokyo metro/private rail | Same usage as Suica |
| **ICOCA (イコカ)** | Osaka/JR West | Works nationally |
| **Kitaca** | Hokkaido | Works nationally |
...
- [Driving in Japan as a Foreigner](/daily-life/driving-in-japan-foreigner/)
