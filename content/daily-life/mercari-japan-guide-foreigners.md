---
title: "Mercari Japan Guide for Foreigners: Buy and Sell Second-Hand in Japan (2026)"
date: 2026-05-25
description: "Complete Mercari Japan guide for foreigners 2026: how to set up an account, buy and sell in Japanese, payment methods, shipping, and tips for finding the best deals as a foreigner."
...
**Foreign card issues:** Mercari Japan has inconsistent acceptance of non-Japan-issued cards. If your foreign card is rejected, use PayPay (loaded with cash from a konbini) or a Japanese credit card. The [Rakuten Card](/money/rakuten-card-foreigners-japan/) is the most accessible option for foreigners.
...
**Can foreigners use Mercari in Japan?**
Yes — foreigners can use Mercari Japan with a Japanese phone number, email address, and payment method. The interface is in Japanese, but Chrome auto-translate makes it navigable. A Japanese credit card or PayPay is needed for payment since foreign cards are sometimes rejected.

**Is Mercari Japan the same as Mercari US?**
No — they are completely separate platforms with different users and inventory. Mercari Japan is the original and has ~70M registered users. A US Mercari account cannot be used on the Japanese platform.

**What is the best way to find furniture on Mercari Japan?**
Search in Japanese for the specific item (use Google Translate to convert English terms to Japanese). Filter by condition 良い (good) or better, and check seller ratings. Furniture in Japan often sells for 50–80% below retail price.
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Can foreigners use Mercari in Japan?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes — foreigners can use Mercari Japan with a Japanese phone number, email, and payment method. Chrome auto-translate makes the Japanese interface navigable."
      }
    },
    {
      "@type": "Question",
      "name": "Is Mercari Japan the same as Mercari US?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No — they are completely separate platforms with different users and inventory. A US Mercari account cannot be used on the Japanese platform."
      }
    }
  ]
}
